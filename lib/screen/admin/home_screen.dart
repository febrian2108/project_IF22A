    ...
    return SingleChildScrollView(
      ...
      child: Column (
        children: [
          ...
          child: Image(
            image: 
            NetworkImage('https://raw.githubusercontent.com/reflan/project_si21a/main/asset/images/Web-header-UTI-23.jpg'),
          ),
        ),
        Container(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  IconButton('Dosen', Icons.people, 1),
        ...
        SizedBox(
          ...
          child: ListView(
            children: [
              CarouselSlider(
                items: [
                  BeritaTerkini('https://teknokrat.ac.id/wp-content/uploads/2023/04/Sekar-Kinasih-040423-1.jpg', 'judul1', 'tanggal 1'),
                  BeritaTerkini('https://teknokrat.ac.id/wp-content/uploads/2023/01/WhatsApp-Image-2023-01-04-at-18.00.09.jpeg', 'judul2', 'tanggal 2'),
                  BeritaTerkini('https://teknokrat.ac.id/wp-content/uploads/2023/04/Tim-Tari-Teknokrat-120323.jpeg', 'judul3', 'tanggal 3'),
                  BeritaTerkini('https://teknokrat.ac.id/wp-content/uploads/2023/04/ddaa.png', 'judul4', 'tanggal 4'),
                  BeritaTerkini('https://teknokrat.ac.id/wp-content/uploads/2023/04/Sekar-Kinasih-040423-1.jpg', 'judul5', 'tanggal 5'),
                  ], 
...
class IconButton extends StatelessWidget {
  ...
  List<Map> _fragment = [
    ...
    {'title':'Data Dosen', 'view': ListDosen()}
  ];
